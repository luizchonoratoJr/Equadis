...
package local_project.addfoundclient_api_1_0;
...
/**
 * Job: addFoundClient_API Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class addFoundClient_API implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "addFoundClient_API.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(addFoundClient_API.class);
	...
	private final String jobName = "addFoundClient_API";
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_AOWUAIFLEe6osYQNKL18nA", "1.0");
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_AOWUAIFLEe6osYQNKL18nA", "1.0");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					addFoundClient_API.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(addFoundClient_API.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class outSqlCreateStruct implements routines.system.IPersistableRow<outSqlCreateStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_addFoundClient_API = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_addFoundClient_API = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final outSqlCreateStruct other = (outSqlCreateStruct) obj;
		...
		public void copyDataTo(outSqlCreateStruct other) {
		...
		public void copyKeysDataTo(outSqlCreateStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_addFoundClient_API.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_addFoundClient_API.length == 0) {
						commonByteArray_LOCAL_PROJECT_addFoundClient_API = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_addFoundClient_API = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_addFoundClient_API, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_addFoundClient_API, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_addFoundClient_API) {
					...
					class tFixedFlowInput_1Thread extends TalendThread {// implements
						...
						class ThreadedMap extends java.util.HashMap<String, Object> {
							...
							public Object put(String key, Object value) {
								...
								synchronized (addFoundClient_API.this.obj) {

									super.put(key, value);
									return addFoundClient_API.this.globalMap.put(key, value);
						...
						public tFixedFlowInput_1Thread(java.util.Map<String, Object> globalMap, row1Struct row1,
							...
							if (outSqlCreate != null) {
								...
								this.outSqlCreate.accountId = outSqlCreate.accountId;
...
// # Output table : 'outSqlCreate'
											...
											outSqlCreate_tmp.accountId = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
...
// ###############################
									...
									class BytesLimit65535_tDBOutput_1 {
										public void limitLog4jByte() throws Exception {
											...
											log4jParamters_tDBOutput_1.append("PASS" + " = " + String.valueOf(
													"enc:routine.encryption.key.v1:ayzcW4l+3J9Y7EJEWdygiQQKRdI9MLuv1ZVoXw==")
													.substring(0, 4) + "...");
											log4jParamters_tDBOutput_1.append(" | ");
								...
								if (null != dataSources_tDBOutput_1) {
									...
									final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:wk6qBQr7dUjIsDpZAkQWekdkOxefuE0WGYD3Xw==");
...
// Start of branch "outSqlCreate"
									if (outSqlCreate != null) {
										...
										if (outSqlCreate.accountId == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, outSqlCreate.accountId);
										}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final addFoundClient_API addFoundClient_APIClass = new addFoundClient_API();

		int exitCode = addFoundClient_APIClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'addFoundClient_API' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'addFoundClient_API' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = addFoundClient_API.class.getClassLoader()
					.getResourceAsStream("local_project/addfoundclient_api_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = addFoundClient_API.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : addFoundClient_API");
		}
...
/************************************************************************************************
 * 136085 characters generated by Talend Data Management Platform on the 12 de
 * Novembro de 2023 14h43min4s GMT
 ************************************************************************************************/