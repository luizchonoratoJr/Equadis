...
package local_project.deposit_withdraw_api_1_0;
...
/**
 * Job: deposit_Withdraw_API Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class deposit_Withdraw_API implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "deposit_Withdraw_API.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(deposit_Withdraw_API.class);
	...
	private final String jobName = "deposit_Withdraw_API";
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_-PJzsIFbEe6osYQNKL18nA", "1.0");
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_-PJzsIFbEe6osYQNKL18nA", "1.0");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					deposit_Withdraw_API.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(deposit_Withdraw_API.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out_actionStruct implements routines.system.IPersistableRow<out_actionStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API.length == 0) {
						commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_deposit_Withdraw_API) {
		 ...
		 * Compare keys
		 */
		public int compareTo(out_actionStruct other) {
	...
	public void tRESTClient_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				out_actionStruct out_action = new out_actionStruct();
...
// expected response body
				...
				try {
					...
					// set request path
					webClient_tRESTClient_1.path("/addfounds");
					...
					class tFixedFlowInput_1Thread extends TalendThread {// implements
						...
						class ThreadedMap extends java.util.HashMap<String, Object> {
							...
							public Object put(String key, Object value) {
								...
								synchronized (deposit_Withdraw_API.this.obj) {

									super.put(key, value);
									return deposit_Withdraw_API.this.globalMap.put(key, value);
						...
						public tFixedFlowInput_1Thread(java.util.Map<String, Object> globalMap, row1Struct row1,
								row2Struct row2, out_actionStruct out_action, int threadID) {
							super();
							...
							if (out_action != null) {
								...
								this.out_action.clientDoc = out_action.clientDoc;

								this.out_action.clientName = out_action.clientName;

								this.out_action.Value = out_action.Value;

								this.out_action.account = out_action.account;

								this.out_action.Action = out_action.Action;
...
// # Outputs initialization
								out_actionStruct out_action_tmp = new out_actionStruct();
								out_actionStruct out_action_save = null;
//the aggregate variable
								out_actionStruct out_action_aggregate = null;
								int count_out_action_tXMLMap_1_TXMLMAP_OUT = 0;
...
// ###############################
								...
								for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
									...
									absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "row2.body:/root/Action";
									relativePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "Action";

									absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "row2.body:/root/Value";
									relativePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "Value";

									absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[4] = "row2.body:/root/clientDoc";
									relativePathMappings_tXMLMap_1_TXMLMAP_OUT[4] = "clientDoc";
...
// # Output table : 'out_action'
											count_out_action_tXMLMap_1_TXMLMAP_OUT++;

											out_action_tmp = new out_actionStruct();
											out_action_tmp.clientDoc = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
													.get_String("row2.body:/root/clientDoc");
											out_action_tmp.clientName = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
													.get_String("row2.body:/root/clientName");
											out_action_tmp.Value = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
													.get_BigDecimal("row2.body:/root/Value");
											out_action_tmp.account = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
													.get_String("row2.body:/root/account");
											out_action_tmp.Action = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
													.get_String("row2.body:/root/Action");
											allOutsForAggregate_tXMLMap_1.add(out_action_tmp);

											log.debug("tXMLMap_1 - Outputting the record "
													+ count_out_action_tXMLMap_1_TXMLMAP_OUT
													+ " of the output table 'out_action'.");
...
// ###############################
								...
								log.debug("tXMLMap_1 - Written records count in the table 'out_action': "
										+ count_out_action_tXMLMap_1_TXMLMAP_OUT + ".");
								...
								if (enableLogStash) {
									runStat.log(resourceMap, iterateId, 0, 0, "out_action");
								}
									...
									class BytesLimit65535_tFlowToIterate_2 {
										public void limitLog4jByte() throws Exception {
											...
											log4jParamters_tFlowToIterate_2.append("MAP" + " = " + "[{VALUE="
													...
													+ ("clientName") + ", KEY=" + ("\"clientName\"") + "}, {VALUE="
													+ ("Value") + ", KEY=" + ("\"Value\"") + "}, {VALUE=" + ("account")
													+ ", KEY=" + ("\"account\"") + "}, {VALUE=" + ("Action") + ", KEY="
													+ ("\"Action\"") + "}]");
											log4jParamters_tFlowToIterate_2.append(" | ");
											if (log.isDebugEnabled())
								...
								for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
									...
									if (row_out_tXMLMap_1_TXMLMAP_IN != null
											&& row_out_tXMLMap_1_TXMLMAP_IN instanceof out_actionStruct) {
										out_action = (out_actionStruct) row_out_tXMLMap_1_TXMLMAP_IN;
									}
...
// Start of branch "out_action"
									if (out_action != null) {
										...
										if (enableLogStash) {
											runStat.log(iterateId, 1, 1, "out_action");
										}

										if (log.isTraceEnabled()) {
											log.trace("out_action - "
													+ (out_action == null ? "" : out_action.toLogString()));
										}

										if (log.isTraceEnabled())
											log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("clientDoc")
													+ (", value=") + (out_action.clientDoc) + ("."));
										globalMap.put("clientDoc", out_action.clientDoc);
										if (log.isTraceEnabled())
											log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("clientName")
													+ (", value=") + (out_action.clientName) + ("."));
										globalMap.put("clientName", out_action.clientName);
										if (log.isTraceEnabled())
											log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("Value")
													+ (", value=") + (out_action.Value) + ("."));
										globalMap.put("Value", out_action.Value);
										if (log.isTraceEnabled())
											log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("account")
													+ (", value=") + (out_action.account) + ("."));
										globalMap.put("account", out_action.account);
										if (log.isTraceEnabled())
											log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("Action")
													+ (", value=") + (out_action.Action) + ("."));
										globalMap.put("Action", out_action.Action);
								...
								if (enableLogStash) {
									...
									if (runStat.log(resourceMap, iterateId, "out_action", 2, 0, talendJobLog,
								...
								if (((String) globalMap.get("Action")).equals("withdraw")) {

									tFixedFlowInput_4Process(globalMap);
								}

								if (((String) globalMap.get("Action")).equals("deposit")) {
					...
					tFixedFlowInput_1Thread bt_tFixedFlowInput_1 = new tFixedFlowInput_1Thread(globalMap, row1, row2,
							out_action, threadIdCounter_tFixedFlowInput_1++);
...
// [tRESTCliend_end]
	...
	public static class out_withdrawStruct implements routines.system.IPersistableRow<out_withdrawStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final out_withdrawStruct other = (out_withdrawStruct) obj;
		...
		public void copyDataTo(out_withdrawStruct other) {
		...
		public void copyKeysDataTo(out_withdrawStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(out_withdrawStruct other) {
	...
	public static class after_tFixedFlowInput_4Struct
			implements routines.system.IPersistableRow<after_tFixedFlowInput_4Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(after_tFixedFlowInput_4Struct other) {
	...
	public void tFixedFlowInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				out_withdrawStruct out_withdraw = new out_withdrawStruct();
				...
				if (enableLogStash) {
					runStat.log(resourceMap, iterateId, 0, 0, "out_withdraw");
				}
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("HOST" + " = " + "\"testequadis\"");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("PORT" + " = " + "\"1433\"");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("DB_SCHEMA" + " = " + "\"\"");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("DBNAME" + " = " + "\"testequadis\"");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("USER" + " = " + "\"testequadis\"");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:KHoyoxmoDR8MIg+coQs0R3I+u7JC8GXNYoXfTg==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"testequadis\"");
							log4jParamters_tDBOutput_2.append(" | ");
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "true");
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("DATASOURCE_ALIAS" + " = " + "\"string_testequadis\"");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_2", "tMSSqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				java.util.Map<String, routines.system.TalendDataSource> dataSources_tDBOutput_2 = (java.util.Map<String, routines.system.TalendDataSource>) globalMap
						.get(KEY_DB_DATASOURCES);
				if (null != dataSources_tDBOutput_2) {
					String dsAlias_tDBOutput_2 = "string_testequadis";
					if (dataSources_tDBOutput_2.get(dsAlias_tDBOutput_2) == null) {
						throw new RuntimeException("No DataSource with alias: " + dsAlias_tDBOutput_2 + " available!");
					}
					conn_tDBOutput_2 = dataSources_tDBOutput_2.get(dsAlias_tDBOutput_2).getConnection();
				} else {
					...
					String dbname_tDBOutput_2 = "testequadis";
					String url_tDBOutput_2 = "jdbc:jtds:sqlserver://" + "testequadis";
					if (!"".equals(port_tDBOutput_2)) {
						url_tDBOutput_2 += ":" + "1433";
					}
					if (!"".equals(dbname_tDBOutput_2)) {
						url_tDBOutput_2 += "//" + "testequadis";

					}
					url_tDBOutput_2 += ";appName=" + projectName + ";" + "";
					dbUser_tDBOutput_2 = "testequadis";

					final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:f75cwN31rpM58PygAzKgbOz5ls+8cpK92+ZZ7w==");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = "testequadis";
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "].[" + "testequadis";
				}
				int count_tDBOutput_2 = 0;

				String insert_tDBOutput_2 = "INSERT INTO [" + tableName_tDBOutput_2
						+ "] ([clientDoc],[clientName],[value],[accountId]) VALUES (?,?,?,?)";
				...
				if (enableLogStash) {
					runStat.log(resourceMap, iterateId, 0, 0, "row6");
				}
...
// ###############################
// # Outputs initialization
				int count_out_withdraw_tMap_2 = 0;

				out_withdrawStruct out_withdraw_tmp = new out_withdrawStruct();
// ###############################
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFixedFlowInput_4", "tFixedFlowInput");
					talendJobLogProcess(globalMap);
				}

				for (int i_tFixedFlowInput_4 = 0; i_tFixedFlowInput_4 < 1; i_tFixedFlowInput_4++) {

					row6.clientDoc = ((String) globalMap.get("clientDoc"));

					row6.clientName = ((String) globalMap.get("clientName"));

					row6.Value = ((BigDecimal) globalMap.get("Value"));

					row6.account = ((String) globalMap.get("account"));

					row6.Action = ((String) globalMap.get("Action"));
					...
					if (enableLogStash) {
						runStat.log(iterateId, 1, 1, "row6");
					}
					...
					if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
						...
						row7HashKey.accountId = row6.account;
					...
					if (tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
						...
						// and it contains more one result from keys : row7.accountId = '" +
						// row7HashKey.accountId + "'");
					} // G 071
					...
					{ // start of Var scope
						...
						Var.var_withdraw = row7.value.compareTo(BigDecimal.valueOf(0.7)) > 0
								? row7.value.subtract(row6.Value)
								: row7.value;// ###############################
						// ###############################
						// # Output tables
...
// # Output table : 'out_withdraw'
							count_out_withdraw_tMap_2++;

							out_withdraw_tmp.clientDoc = row6.clientDoc;
							out_withdraw_tmp.clientName = row6.clientName;
							out_withdraw_tmp.value = Var.var_withdraw;
							out_withdraw_tmp.accountId = row6.account;
							out_withdraw = out_withdraw_tmp;
							log.debug("tMap_2 - Outputting the record " + count_out_withdraw_tMap_2
									+ " of the output table 'out_withdraw'.");
...
// ###############################
					 ...
					 */
// Start of branch "out_withdraw"
					if (out_withdraw != null) {
						...
						if (enableLogStash) {
							runStat.log(iterateId, 1, 1, "out_withdraw");
						}

						if (log.isTraceEnabled()) {
							log.trace("out_withdraw - " + (out_withdraw == null ? "" : out_withdraw.toLogString()));
						}

						whetherReject_tDBOutput_2 = false;
						if (out_withdraw.clientDoc == null) {
							pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(1, out_withdraw.clientDoc);
						}

						if (out_withdraw.clientName == null) {
							pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(2, out_withdraw.clientName);
						}

						pstmt_tDBOutput_2.setBigDecimal(3, out_withdraw.value);

						if (out_withdraw.accountId == null) {
							pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(4, out_withdraw.accountId);
						}
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'out_withdraw': " + count_out_withdraw_tMap_2
						+ ".");

				if (enableLogStash) {

					if (runStat.log(resourceMap, iterateId, "row6", 2, 0, talendJobLog, "tFixedFlowInput_4",
							"tFixedFlowInput", "tMap_2", "tMap", "output")) {
						talendJobLogProcess(globalMap);
					}
				...
				if (log.isDebugEnabled())
					log.debug("tDBOutput_2 - " + ("Connection starting to commit ") + (commitCounter_tDBOutput_2)
							+ (" record(s)."));
				conn_tDBOutput_2.commit();
				...
				if (enableLogStash) {
					...
					if (runStat.log(resourceMap, iterateId, "out_withdraw", 2, 0, talendJobLog, "tMap_2", "tMap",
							"tDBOutput_2", "tMSSqlOutput", "output")) {
						talendJobLogProcess(globalMap);
					}
	...
	public static class out_depositStruct implements routines.system.IPersistableRow<out_depositStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_deposit_Withdraw_API = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final out_depositStruct other = (out_depositStruct) obj;
		...
		public void copyDataTo(out_depositStruct other) {
		...
		public void copyKeysDataTo(out_depositStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(out_depositStruct other) {
	...
	public void tFixedFlowInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				out_depositStruct out_deposit = new out_depositStruct();
				...
				if (enableLogStash) {
					runStat.log(resourceMap, iterateId, 0, 0, "out_deposit");
				}
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:/XLdFC3w7F5EYUvhlqTOFhJQyXBiBazx3joxUg==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "true");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("DATASOURCE_ALIAS" + " = " + "\"string_testequadis\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (null != dataSources_tDBOutput_1) {
					...
					if (dataSources_tDBOutput_1.get(dsAlias_tDBOutput_1) == null) {
						throw new RuntimeException("No DataSource with alias: " + dsAlias_tDBOutput_1 + " available!");
					}
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:H4K1JbHimRH2CxFIlBzBeZWm6PpU2g8zpgNW5w==");
...
// ###############################
// # Outputs initialization
				int count_out_deposit_tMap_1 = 0;

				out_depositStruct out_deposit_tmp = new out_depositStruct();
// ###############################
				...
				if (enableLogStash) {
					talendJobLog.addCM("tFixedFlowInput_3", "tFixedFlowInput");
					talendJobLogProcess(globalMap);
				}

				for (int i_tFixedFlowInput_3 = 0; i_tFixedFlowInput_3 < 1; i_tFixedFlowInput_3++) {

					row4.clientDoc = ((String) globalMap.get("clientDoc"));

					row4.clientName = ((String) globalMap.get("clientName"));

					row4.value = ((BigDecimal) globalMap.get("Value"));

					row4.account = ((String) globalMap.get("account"));

					row4.Action = ((String) globalMap.get("Action"));
					...
					if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
						...
						row5HashKey.clientDoc = row4.clientDoc;
					...
					if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
						...
						// and it contains more one result from keys : row5.clientDoc = '" +
						// row5HashKey.clientDoc + "', row5.accountId = '" + row5HashKey.accountId +
						// "'");
					} // G 071
					...
					{ // start of Var scope
						...
						Var.var_value = row4.value.compareTo(BigDecimal.valueOf(0.7)) > 0 ? row4.value.add(row5.value)
								: row5.value;// ###############################
						// ###############################
						// # Output tables
...
// # Output table : 'out_deposit'
							count_out_deposit_tMap_1++;

							out_deposit_tmp.clientDoc = row5.clientDoc;
							out_deposit_tmp.clientName = row5.clientName;
							out_deposit_tmp.value = Var.var_value;
							out_deposit_tmp.accountId = row4.account;
							out_deposit = out_deposit_tmp;
							log.debug("tMap_1 - Outputting the record " + count_out_deposit_tMap_1
									+ " of the output table 'out_deposit'.");
...
// Start of branch "out_deposit"
					if (out_deposit != null) {
						...
						if (enableLogStash) {
							runStat.log(iterateId, 1, 1, "out_deposit");
						}

						if (log.isTraceEnabled()) {
							log.trace("out_deposit - " + (out_deposit == null ? "" : out_deposit.toLogString()));
						}

						whetherReject_tDBOutput_1 = false;
						if (out_deposit.clientDoc == null) {
							pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(1, out_deposit.clientDoc);
						}

						if (out_deposit.clientName == null) {
							pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, out_deposit.clientName);
						}

						pstmt_tDBOutput_1.setBigDecimal(3, out_deposit.value);

						if (out_deposit.accountId == null) {
							pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(4, out_deposit.accountId);
						}
...
// ###############################      
				log.debug(
						"tMap_1 - Written records count in the table 'out_deposit': " + count_out_deposit_tMap_1 + ".");

				if (enableLogStash) {

					if (runStat.log(resourceMap, iterateId, "row4", 2, 0, talendJobLog, "tFixedFlowInput_3",
							"tFixedFlowInput", "tMap_1", "tMap", "output")) {
						talendJobLogProcess(globalMap);
					}
				...
				if (enableLogStash) {
					...
					if (runStat.log(resourceMap, iterateId, "out_deposit", 2, 0, talendJobLog, "tMap_1", "tMap",
							"tDBOutput_1", "tMSSqlOutput", "output")) {
						talendJobLogProcess(globalMap);
					}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_1 - inputs:(after_tFixedFlowInput_3) outputs:(row5,row5)
				// | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
				// linked node: tMap_1 - inputs:(row4,row5) outputs:(out_deposit)
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:GT0u2chnM1OoG5PrEAzy7fJg6Y41oimsTScv6w==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/WzPVtJk5SkbSCwtSXwMwFQWFZBJo+/YfZK37w==");
	...
	public static class row7Struct implements routines.system.IPersistableComparableLookupRow<row7Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.clientDoc = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.clientDoc, dos, oos);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					runStat.log(resourceMap, iterateId, 0, 0, "row7");
				}
				...
				// source node:tDBInput_2 - inputs:(after_tFixedFlowInput_4) outputs:(row7,row7)
				// | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
				// linked node: tMap_2 - inputs:(row6,row7) outputs:(out_withdraw)
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("HOST" + " = " + "\"testequadis\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("DRIVER" + " = " + "JTDS");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("PORT" + " = " + "\"1433\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("DB_SCHEMA" + " = " + "\"testequadis\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("DBNAME" + " = " + "\"testequadis\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("USER" + " = " + "\"testequadis\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:Vz5VctHb7vS0UJrJcQNyk05klVR+8aY8Z0HwJA==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tDBInput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_2", "tMSSqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbUser_tDBInput_2 = "testequadis";

				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:dSTNlcHQzqeVMvKw1en3jyW8TuSY0TggJ9TNxA==");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String port_tDBInput_2 = "1433";
				String dbname_tDBInput_2 = "testequadis";
				String url_tDBInput_2 = "jdbc:jtds:sqlserver://" + "testequadis";
				if (!"".equals(port_tDBInput_2)) {
					url_tDBInput_2 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_2)) {
					url_tDBInput_2 += "//" + "testequadis";
				}
				url_tDBInput_2 += ";appName=" + projectName + ";" + "noDatetimeStringSync=true";
				String dbschema_tDBInput_2 = "testequadis";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row7.clientDoc = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row7.clientDoc = tmpContent_tDBInput_2;
								}
							} else {
								row7.clientDoc = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row7.clientName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row7.clientName = tmpContent_tDBInput_2;
								}
							} else {
								row7.clientName = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row7.value = rs_tDBInput_2.getBigDecimal(3);
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row7.accountId = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row7.accountId = tmpContent_tDBInput_2;
								}
							} else {
								row7.accountId = null;
							}
						...
						if (enableLogStash) {
							runStat.log(iterateId, 1, 1, "row7");
						}
						...
						row7_HashRow.clientDoc = row7.clientDoc;

						row7_HashRow.clientName = row7.clientName;

						row7_HashRow.value = row7.value;

						row7_HashRow.accountId = row7.accountId;
				...
				if (enableLogStash) {
					...
					if (runStat.log(resourceMap, iterateId, "row7", 2, 0, talendJobLog, "tDBInput_2", "tMSSqlInput",
							"tAdvancedHash_row7", "tAdvancedHash", "output")) {
						talendJobLogProcess(globalMap);
					}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final deposit_Withdraw_API deposit_Withdraw_APIClass = new deposit_Withdraw_API();

		int exitCode = deposit_Withdraw_APIClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'deposit_Withdraw_API' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'deposit_Withdraw_API' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = deposit_Withdraw_API.class.getClassLoader().getResourceAsStream(
					"local_project/deposit_withdraw_api_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = deposit_Withdraw_API.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : deposit_Withdraw_API");
		}
...
/************************************************************************************************
 * 273859 characters generated by Talend Data Management Platform on the 12 de
 * Novembro de 2023 14h52min52s GMT
 ************************************************************************************************/